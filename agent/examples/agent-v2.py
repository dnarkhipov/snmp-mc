"""
https://stackoverflow.com/questions/16213660/snmp-agent-in-python

$ snmpset -v2c -c public localhost:1161 .1.3.6.10 s 'test2'
$ snmpget -v2c -c public localhost:1161 .1.3.6.10
"""
